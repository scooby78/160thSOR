...
class SOR_MELB_H6M_W : SOR_MELB_H6M
{
	editorCategory = "SOR_Cat_Faction_W";
	editorSubcategory = "SOR_SubCat_Aircraft";
	vehicleclass = "SOR_Aircraft";
...
class SOR_MELB_MH6M_W : SOR_MELB_MH6M
{
	editorCategory = "SOR_Cat_Faction_W";
	editorSubcategory = "SOR_SubCat_Aircraft";
	vehicleclass = "SOR_Aircraft";
...
class SOR_MELB_MH6M_MEV_W : SOR_MELB_MH6M_MEV
{
	editorCategory = "SOR_Cat_Faction_W";
	editorSubcategory = "SOR_SubCat_Aircraft";
	vehicleclass = "SOR_Aircraft";
...
// Attack Helos	
class SOR_MELB_AH6M_L_W : SOR_MELB_AH6M_L
{
	editorCategory = "SOR_Cat_Faction_W";
	editorSubcategory = "SOR_SubCat_Aircraft";
	vehicleclass = "SOR_Aircraft";
...
class SOR_MELB_AH6M_M_W : SOR_MELB_AH6M_M
{
	editorCategory = "SOR_Cat_Faction_W";
	editorSubcategory = "SOR_SubCat_Aircraft";
	vehicleclass = "SOR_Aircraft";
...
class SOR_MELB_AH6M_H_W : SOR_MELB_AH6M_H
{
	editorCategory = "SOR_Cat_Faction_W";
	editorSubcategory = "SOR_SubCat_Aircraft";
	vehicleclass = "SOR_Aircraft";
