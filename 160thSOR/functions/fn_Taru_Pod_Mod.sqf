...
Script_Taru =
{
	...
	{
		_taru_Arrimer = ["Taru_Arrimer",localize "STR_XENO_Arrimer","160thSOR\data\XENO_Pod.paa",{["Arrimage", player] call Script_Choix_Unite;},{[vehicle player] call Script_Verification_Pod and {!([vehicle player] call Script_Verification_Objet_Attacher)}}] call ace_interact_menu_fnc_createAction;
		["SOR_O_Heli_Transport_04_F", 1, ["ACE_SelfActions"], _taru_Arrimer] call ace_interact_menu_fnc_addActionToClass;

		_taru_Desarrimer = ["Taru_Desarrimer",localize "STR_XENO_Desarrimer","160thSOR\data\XENO_Pod.paa",{["Desarrimage", player] call Script_Choix_Unite;},{[vehicle player] call Script_Verification_Objet_Attacher}] call ace_interact_menu_fnc_createAction;
		["SOR_O_Heli_Transport_04_F", 1, ["ACE_SelfActions"], _taru_Desarrimer] call ace_interact_menu_fnc_addActionToClass;

		_taru_Larguer = ["Taru_Larguer",localize "STR_XENO_Larguer","160thSOR\data\XENO_Pod.paa",{["Largage", player] call Script_Choix_Unite;},{[vehicle player] call Script_Verification_Objet_Attacher}] call ace_interact_menu_fnc_createAction;
		["SOR_O_Heli_Transport_04_F", 1, ["ACE_SelfActions"], _taru_Larguer] call ace_interact_menu_fnc_addActionToClass;
	};
...
Script_Taru_Arrimer_Pod =
{
	...
	[] call
	{
...

		{
			...
			if (_x isEqualTo "SOR_Land_Pod_Heli_Transport_04_medevac_F") exitwith
			{
				_objet_Heliporter attachTo [_helico,[-0.14,-1.05,-0.92]];
				_helico setCustomWeightRTD 1321;
				_helico setmass _mass_Objet_Heliporter + _mass_Helicoptere;
